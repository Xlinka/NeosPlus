...
namespace FrooxEngine
{
    public class ClothConnector : MeshRendererConnectorBase<Cloth, UnityEngine.SkinnedMeshRenderer>
    {
        ...
        private void SetupCloth()
        {
            ...
            if (Owner.ExternalAcceleration.WasChanged)
                UnityCloth.externalAcceleration = Conversions.ToUnity(Owner.ExternalAcceleration);

            if (Owner.RandomAcceleration.WasChanged)
            ...
            if (Owner.WorldAccelerationScale.WasChanged)
            ...
            if (Owner.UseContinuousCollision.WasChanged)
