...
public static class CollectionsHelperSyncAssetList<T> where T : class, IAsset
{
    ...
    public static void Insert(SyncAssetList<T> collection, int index, IAssetProvider<T> obj) => collection.Insert(index, obj);
    public static void Remove(SyncAssetList<T> collection, int index) => collection.RemoveAt(index);
    public static void Set(SyncAssetList<T> collection, int index, IAssetProvider<T> obj) => collection.GetElement(index).Target = obj;
}
public static class CollectionsHelperSyncDelegateList<T> where T : class
{
    ...
    public static void Set(SyncDelegateList<T> collection, int index, T obj) => collection.GetElement(index).Target = obj;
}
